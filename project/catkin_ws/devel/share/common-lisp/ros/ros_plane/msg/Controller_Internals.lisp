...
(cl:defmethod cl:initialize-instance :after ((m <Controller_Internals>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Controller_Internals)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_plane-msg:<Controller_Internals> is deprecated: use ros_plane-msg:Controller_Internals instead.")))

(cl:ensure-generic-function 'theta_c-val :lambda-list '(m))
(cl:defmethod theta_c-val ((m <Controller_Internals>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:theta_c-val is deprecated.  Use ros_plane-msg:theta_c instead.")
  (theta_c m))

(cl:ensure-generic-function 'phi_c-val :lambda-list '(m))
(cl:defmethod phi_c-val ((m <Controller_Internals>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:phi_c-val is deprecated.  Use ros_plane-msg:phi_c instead.")
  (phi_c m))

(cl:ensure-generic-function 'alt_zone-val :lambda-list '(m))
(cl:defmethod alt_zone-val ((m <Controller_Internals>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:alt_zone-val is deprecated.  Use ros_plane-msg:alt_zone instead.")
  (alt_zone m))

(cl:ensure-generic-function 'aux-val :lambda-list '(m))
(cl:defmethod aux-val ((m <Controller_Internals>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:aux-val is deprecated.  Use ros_plane-msg:aux instead.")
  (aux m))

(cl:ensure-generic-function 'aux_valid-val :lambda-list '(m))
(cl:defmethod aux_valid-val ((m <Controller_Internals>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:aux_valid-val is deprecated.  Use ros_plane-msg:aux_valid instead.")
  (aux_valid m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Controller_Internals>)))
  ...
  "ros_plane/Controller_Internals")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Controller_Internals)))
  "Returns string type for a message object of type 'Controller_Internals"
  "ros_plane/Controller_Internals")
