...
(cl:defmethod cl:initialize-instance :after ((m <Controller_Commands>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Controller_Commands)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_plane-msg:<Controller_Commands> is deprecated: use ros_plane-msg:Controller_Commands instead.")))

(cl:ensure-generic-function 'Va_c-val :lambda-list '(m))
(cl:defmethod Va_c-val ((m <Controller_Commands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:Va_c-val is deprecated.  Use ros_plane-msg:Va_c instead.")
  (Va_c m))

(cl:ensure-generic-function 'h_c-val :lambda-list '(m))
(cl:defmethod h_c-val ((m <Controller_Commands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:h_c-val is deprecated.  Use ros_plane-msg:h_c instead.")
  (h_c m))

(cl:ensure-generic-function 'chi_c-val :lambda-list '(m))
(cl:defmethod chi_c-val ((m <Controller_Commands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:chi_c-val is deprecated.  Use ros_plane-msg:chi_c instead.")
  (chi_c m))
