...
(cl:defmethod cl:initialize-instance :after ((m <Waypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Waypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_plane-msg:<Waypoint> is deprecated: use ros_plane-msg:Waypoint instead.")))

(cl:ensure-generic-function 'w-val :lambda-list '(m))
(cl:defmethod w-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:w-val is deprecated.  Use ros_plane-msg:w instead.")
  (w m))

(cl:ensure-generic-function 'chi_d-val :lambda-list '(m))
(cl:defmethod chi_d-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:chi_d-val is deprecated.  Use ros_plane-msg:chi_d instead.")
  (chi_d m))

(cl:ensure-generic-function 'chi_valid-val :lambda-list '(m))
(cl:defmethod chi_valid-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:chi_valid-val is deprecated.  Use ros_plane-msg:chi_valid instead.")
  (chi_valid m))
...
(cl:defmethod set_current-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_plane-msg:set_current-val is deprecated.  Use ros_plane-msg:set_current instead.")
  (set_current m))
