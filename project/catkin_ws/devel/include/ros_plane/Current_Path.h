// Generated by gencpp from file ros_plane/Current_Path.msg
// DO NOT EDIT!


#ifndef ROS_PLANE_MESSAGE_CURRENT_PATH_H
#define ROS_PLANE_MESSAGE_CURRENT_PATH_H
...
struct Current_Path_
{
  ...
  typedef boost::shared_ptr< ::ros_plane::Current_Path_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ros_plane::Current_Path_<ContainerAllocator> const> ConstPtr;

}; // struct Current_Path_

typedef ::ros_plane::Current_Path_<std::allocator<void> > Current_Path;

typedef boost::shared_ptr< ::ros_plane::Current_Path > Current_PathPtr;
typedef boost::shared_ptr< ::ros_plane::Current_Path const> Current_PathConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ros_plane::Current_Path_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ros_plane::Current_Path_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ros_plane::Current_Path_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ros_plane::Current_Path_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_plane::Current_Path_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_plane::Current_Path_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_plane::Current_Path_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_plane::Current_Path_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ros_plane::Current_Path_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ros_plane::Current_Path_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4af1751f6b464a5aULL;
  static const uint64_t static_value2 = 0x3cb09551a027be48ULL;
};

template<class ContainerAllocator>
struct DataType< ::ros_plane::Current_Path_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ros_plane::Current_Path_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ros_plane::Current_Path_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ros_plane::Current_Path_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ros_plane::Current_Path_<ContainerAllocator>& v)
  {
    s << indent << "flag: ";
...
#endif // ROS_PLANE_MESSAGE_CURRENT_PATH_H
