...
struct Command_
{
  ...
  _F_type F;
    ...
    enum { MODE_PASS_THROUGH = 0u };
     enum { MODE_ROLLRATE_PITCHRATE_YAWRATE_THROTTLE = 1u };
     enum { MODE_ROLL_PITCH_YAWRATE_THROTTLE = 2u };
     enum { MODE_ROLL_PITCH_YAWRATE_ALTITUDE = 3u };
     enum { MODE_XPOS_YPOS_YAW_ALTITUDE = 4u };
     enum { MODE_XVEL_YVEL_YAWRATE_ALTITUDE = 5u };
     enum { MODE_XACC_YACC_YAWRATE_AZ = 6u };
     enum { IGNORE_NONE = 0u };
     enum { IGNORE_X = 1u };
     enum { IGNORE_Y = 2u };
     enum { IGNORE_Z = 4u };
